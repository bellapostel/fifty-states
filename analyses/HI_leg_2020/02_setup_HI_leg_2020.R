...
kauai_ssd <- kauai_ssd |>
    mutate(pseudo_county = pick_county_muni(kauai_ssd, counties = county, munis = muni,
                                            pop_muni = get_target(kauai_ssd)))
kauai_shd <- kauai_shd |>
    mutate(pseudo_county = pick_county_muni(kauai_shd, counties = county, munis = muni,
                                            pop_muni = get_target(kauai_shd)))
...
attr(maui_shd, "analysis_name") <- "HI_MAUI_SHD_2020"
attr(oahu_shd, "analysis_name") <- "HI_OAHU_SHD_2020"
attr(kauai_shd, "analysis_name") <- "HI_KAUAI_SHD_2020"
#SSDS
attr(hawaii_ssd, "analysis_name") <- "HI_HAWAII_SSD_2020"
attr(maui_ssd, "analysis_name") <- "HI_MAUI_SSD_2020"
attr(kauai_ssd, "analysis_name") <- "HI_KAUAI_SSD_2020"
...
write_rds(kauai_ssd, "data-out/HI_2020/HI_leg_2020_map_ssd_KAUAI.rds", compress = "xz")
write_rds(kauai_shd, "data-out/HI_2020/HI_leg_2020_map_shd_KAUAI.rds", compress = "xz")
cli_process_done()
