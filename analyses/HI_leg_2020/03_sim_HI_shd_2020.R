###############################################################################
# Simulate plans for `HI_shd_2020` SHD
# © ALARM Project, July 2026
###############################################################################

# Run the simulation -----
cli_process_start("Running simulations for {.pkg HI_shd_2020}")
...
mh_accept_per_smc <- ceiling(n_distinct(oahu_shd$shd_2020)/3)
...
plans <- add_summary_stats(plans, oahu_shd)

# TODO edited the below for each of the four basic island units
# Output the summary statistics. Do not edit this path.
save_summary_stats(plans, "data-out/HI_2020/HI_shd_2020_stats_OAHU.csv")
...
if (interactive()) {
    ...
    validate_analysis(plans, oahu_shd)
    summary(plans)
